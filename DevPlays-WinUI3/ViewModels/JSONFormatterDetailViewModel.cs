...
{
    public class JSONFormatterDetailViewModel : ObservableRecipient, INavigationAware
    {
        ...
        public JSONFormatterDetailViewModel(ISampleDataService sampleDataService)
        {
