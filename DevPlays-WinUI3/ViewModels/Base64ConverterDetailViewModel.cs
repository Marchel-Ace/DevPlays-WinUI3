...
{
    public class Base64ConverterDetailViewModel : ObservableRecipient, INavigationAware
    {
        ...
        public Base64ConverterDetailViewModel(ISampleDataService sampleDataService)
        {
