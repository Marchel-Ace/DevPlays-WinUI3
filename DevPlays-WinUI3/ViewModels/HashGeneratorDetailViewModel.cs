...
{
    public class HashGeneratorDetailViewModel : ObservableRecipient, INavigationAware
    {
        ...
        public HashGeneratorDetailViewModel(ISampleDataService sampleDataService)
        {
